...
class AsideCatalog extends Component {
  ...
  render() {
    if (
      this.props.dataFromParent.searchBar.results !== this.state.items &&
      this.props.dataFromParent.searchBar.results !== undefined &&
      !this.props.dataFromParent.updatedatas.data
    ) {
    ...
    if (
      this.props.dataFromParent.updatedatas.data !== this.state.items &&
      this.props.dataFromParent.updatedatas.data !== undefined
    ) {
        ...
        <div>
          {this.state.search && (
            <div className="title_lign">
              <h1>
                Résultats pour votre recherche "<b>{this.state.search}"</b> :
              </h1>
            </div>
          )}
          {!this.state.search && (
            ...
            >
              <div className="row">
                ...
                <div className="col-md-3 text-center pr-0 pl-0">
                  ...
                  {item.promo == true && (
                    <h5>
                      <span className="p-2 mt-2 badge badge-danger">
                        EN PROMO
                      </span>
                    </h5>
                  )}
                  ...
                  {item.stock >= 1 && (
                    <div>
                      <h6 className="text-success">{item.stock} en stock</h6>
                      <br></br>
                      <br></br>
                      <div className="col-md">
                        <button
