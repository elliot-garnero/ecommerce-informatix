...
class ModifProduct extends Component {
    ...
    getProduct() {
        axios.get(`http://localhost:8000/api/products/`+this.state.idProduct)
        .then((res) => {
            this.setState ({
    ...
    render(){
        ...
        <div className="container card">
            <form method="POST" action="/api/modifproduct">
                    ...
                    <input name="idProduct" type="hidden" defaultValue={idProduct}></input>
                    ...
                    <div className="card-header info-color white-text text-center py-4">
                        <label htmlFor="characteristics">Caractéristiques <h6>(séparés par des tirets)</h6></label>
                        <input
                        type="text"
                        className="form-control"
                        id="characteristics"
                    ...
                    <div className="card-header info-color white-text text-center py-4">
                        <label htmlFor="weight">Poids <h6>(en grammes)</h6></label>
                        <input
                        type="number"
                        className="form-control"
                        id="weight"
                    ...
                    <div className="card-header info-color white-text text-center py-4">
                        <label htmlFor="size">Taille <h6>(longueur*largeur*profondeur, en cm)</h6></label>
                        <input
                        type="text"
                        className="form-control"
                        id="size"
