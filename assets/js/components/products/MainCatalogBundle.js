                        ...
                        <div className="col-9">
                            <div id="div_catalog">
                                <div className="row m-3 mt-4">
                                    <h1 className="txt-orange">CATALOGUE</h1>
                                ...
                                <div className="w-100 border border-secondary p-3 mb-2 rounded" key={i} id={item.idBundle}>
                                    <div className="col">
                                        ...
                                        <div className="row mt-2 p-2 text-center">
                                            <img className="col-md-3 p-0" src={item.bundPicture1} width="250px"></img>
                                            <img className="col-md-3 p-0" src={item.bundPicture2} width="250px"></img>
                                            <img className="col-md-3 p-0" src={item.bundPicture3} width="250px"></img>
                                            <img className="col-md-3 p-0" src={item.bundPicture4} width="250px"></img>
                                        </div>
                                        <div className="row m-2">
