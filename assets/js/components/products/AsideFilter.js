            ...
            <form onSubmit = { this.byBrand } method="post">
                <div className="form-row align-items-center">
                    <div className="form-group col-md-10">
                        ...
                        <select value={this.state.search} onChange={this.inputChange} name="brand_name" id="brand_name" className="form-control">
                        {brandList}
                        </select>                        
                    </div>
                </div>
            ...
            <form onSubmit = { this.byName } method="post">
                <div className="form-row align-items-center">
                    <div className="form-group col-md-10">
                        ...
                        <select value={this.state.search} onChange={this.inputChange} name="product_name" id="product_name" className="form-control">
                        {productNameList}
                        </select>                        
                    </div>
                </div>
            ...
            <form onSubmit = { this.byCategorie } method="post">
                <div className="form-row align-items-center">
                    <div className="form-group col-md-10">
                        ...
                        <select value={this.state.search} onChange={this.inputChange} name="categorie_name" id="categorie_name" className="form-control">
                        {categorieList}
                        </select>                        
                    </div>
                </div>
